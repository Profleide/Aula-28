...
var isLaughing= false; // aluno

function preload() {
  backgroundImg = loadImage("./assets/background.gif"); // aluno
...
function draw() {
  ...
  // Colocar musica pra tocar
  if (!backgroundMusic.isPlaying()) {
    backgroundMusic.play(); // aluno
    backgroundMusic.setVolume(0.5); // aluno
  }
...
/*Portanto, primeiro vamos começar escrevendo a condição
para verificar se o navio intacto está tocando na torre.*/
